...
<head>
    <title>Watch <?=$title['romaji']?> - AnimeZia</title>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta name="title" content="Watch <?=$title['romaji']?> - AnimeZia" />
    <meta name="description" content="<?=substr($getAnime['description'],0, 90)?>.... Read More On AnimeZia" />
    ...
    <meta property="og:title" content="Watch <?=$title['romaji']?> - AnimeZia">
    <meta property="og:description" content="<?=substr($getAnime['description'],0, 90)?>.... Read More On AnimeZia.">
    ...
    <meta property="twitter:title" content="Watch <?=$title['romaji']?> - AnimeZia">
    <meta property="twitter:description" ontent="<?=substr($getAnime['description'],0, 90)?>.... Read More On AnimeZia.">
